...
public class SimpleBlueController : MonoBehaviour {
    ...
    public float setMovementRange = 0.005f;
    ...
    private void Awake() {
        ...
        m_Range = m_PlayerTrans.position;
    ...
    private void Update() {
        ...
        //Combat
        m_Distance = Vector3.Distance(m_PlayerTrans.position, m_Red.position);
